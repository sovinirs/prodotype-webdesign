            ...
            <div className='row about-inner'>
              <div className='col-md-6 col-12'>
                <p className='about-text py-5 text-justify'>
                  ...
                  expert team comprising of former Autodesk Interns, best in
                  class product designers, and an exclusive Pan India Team with
                  tonnes of experience on the field work together towards
                  revolutionizing the industry while changing lives through
                  design.
                  <br />
                  <br /> Our simplistic design strategy coupled with a
                  multi-dynamic approach gives us the creative edge in building
                  products that will stand out from the crowd. From the
                  corporate world to the casual, our goal is to give life and
                  soul to everything, everyone has. As professionals, we
                  actively work towards designing products that will stay one
                  step ahead of the industry as we learn, grow and adapt to the
                  exquisite tastes of our customers.
                </p>
              </div>
            ...
            <div className='row about-inner-2'>
              ...
              <div className='col-6'>
                <div className='text-white'>
                  ...
                  <h2 className='about-text'>
                    Through each product design, we build and create to
                    innovate; effectively and efficiently.
                  </h2>
                </div>
              </div>
              <div className='col-2'></div>
