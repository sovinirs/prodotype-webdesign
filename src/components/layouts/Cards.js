          ...
          <div className='card card-body-dark text-center'>
            <a href='!#' style={{ textDecoration: 'none', color: 'white' }}>
              <div className='card-body'>
                ...
                <p className='card-text'>
                  Prodotype solves complex problems that seem impossible through
                  simple design changes and add a dash of elegance to our work.
                </p>
              </div>
            </a>
          </div>
            ...
            <a href='!#' style={{ textDecoration: 'none', color: 'white' }}>
              <div className='card-body'>
                ...
                <p className='card-text'>
                  ...
                  for yourself. We have a collection of unique and aesthetically
                  pleasing designs.
                </p>
              </div>
            </a>
